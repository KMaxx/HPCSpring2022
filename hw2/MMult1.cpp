...
int main(int argc, char** argv) {
  ...
  for (long p = PFIRST; p < PLAST; p += PINC) {
    ...
    double time = t.toc();
    double flops = (8.0/1000000000.0)*m*n*k*NREPEATS/time; // TODO: calculate from m, n, k, NREPEATS, time
    double bandwidth = (2.0/1000000000.0)*(m*n+m*n*k/BLOCK_SIZE)*NREPEATS/time; // TODO: calculate from m, n, k, NREPEATS, time
